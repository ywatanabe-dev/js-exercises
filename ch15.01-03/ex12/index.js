(() => {
  ...
  */
  const command = document.querySelector(
    ".markdown-body.entry-content.container-lg h1"
  ).textContent;
  const parameters = document.querySelector("#user-content-parameters")
  ...
  if (body !== null) {
    ...
    for (const param of params) {
      param_list.push(param.querySelector("td").textContent);
    }
  }
